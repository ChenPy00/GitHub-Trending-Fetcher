```json
{
  ...
  "readme_sha256": "d5c8add03c5483b8136b1282187421f33a1b7d8eebad6937379a692e4d3fa254"
}
```
...
- URL: https://github.com/browser-use/browser-use
- Description: Agents that use the browser.
- README SHA256: `d5c8add03c5483b8136b1282187421f33a1b7d8eebad6937379a692e4d3fa254`
