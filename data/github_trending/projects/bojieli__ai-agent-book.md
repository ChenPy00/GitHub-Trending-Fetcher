```json
{
  ...
  "readme_sha256": "424077c41406d2d871ce7271f7b450c399cd2d7cb9162dba95ff5fc4365f2a2d"
}
```
...
- URL: https://github.com/bojieli/ai-agent-book
- Description: 《深入理解 AI Agent：设计原理与工程实践》（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码
- README SHA256: `424077c41406d2d871ce7271f7b450c399cd2d7cb9162dba95ff5fc4365f2a2d`
